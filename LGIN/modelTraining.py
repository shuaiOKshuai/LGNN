...
def modelTraining(
    ...
    mask_2_nor_tensor = tf.placeholder(dtype=tf.float32, shape=(None, None), name='mask_2_nor_tensor') 
    ...
    mask_1_nor_tensor = tf.placeholder(dtype=tf.float32, shape=(None, None), name='mask_1_nor_tensor')
    train_update_op, gvs_tensor, pred_tensor, loss_tensor, acc_tensor = gnnModel.build_model(options, features_tensor, adj_2_tensor, mask_2_tensor, mask_2_nor_tensor, adj_1_tensor, mask_1_tensor, mask_1_nor_tensor, labels_tensor, dropout_tensor)
        ...
        for epoch in range(train_max_epoch_num):
            _, train_loss_value, train_acc_value = sess.run([train_update_op, loss_tensor, acc_tensor],
                                                            feed_dict={adj_2_tensor : train_adj_2, 
                                                                       ...
                                                                       mask_2_nor_tensor : train_mask_2_nor, 
                                                                       adj_1_tensor : train_adj_1, 
                                                                       mask_1_tensor : train_mask_1,
                                                                       mask_1_nor_tensor : train_mask_1_nor,
            ...
            for val_batch in val_dataset:
                ...
                val_pred_value_batch, val_loss_value_batch, val_acc_value_batch = sess.run([pred_tensor, loss_tensor, acc_tensor],
                                                            feed_dict={adj_2_tensor : val_batch_adj_2, 
                                                                       ...
                                                                       mask_2_nor_tensor : val_batch_mask_2_nor, 
                                                                       adj_1_tensor : val_batch_adj_1, 
                                                                       mask_1_tensor : val_batch_mask_1,
                                                                       mask_1_nor_tensor : val_batch_mask_1_nor,
        ...
        for test_batch in test_dataset:
            ...
            test_pred_value_batch, test_loss_value_batch, test_acc_value_batch = sess.run([pred_tensor, loss_tensor, acc_tensor],
                                                        feed_dict={adj_2_tensor : test_batch_adj_2, 
                                                                   ...
                                                                   mask_2_nor_tensor : test_batch_mask_2_nor, 
                                                                   adj_1_tensor : test_batch_adj_1, 
                                                                   mask_1_tensor : test_batch_mask_1,
                                                                   mask_1_nor_tensor : test_batch_mask_1_nor,
